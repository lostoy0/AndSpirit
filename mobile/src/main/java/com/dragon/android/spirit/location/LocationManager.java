...
public class LocationManager {
    ...
    public void init(Context context) {
        if(!EasyPermissions.hasPermissions(context, Constants.PERMISSIONS)) {
    ...
    private LocationClientOption getLocationClientOption() {
        ...
        //配置获取经纬度所需参数
        configLatitudeLongitude(option);
    ...
    private void configLatitudeLongitude(LocationClientOption option) {
...
//        mLocationClient.requestLocation();
    ...
    public class SpiritLocationListener extends BDAbstractLocationListener {
        ...
        public void onReceiveLocation(BDLocation location){
            ...
            LocationManager.getInstance().stopLocationClient();
        }
    }
}

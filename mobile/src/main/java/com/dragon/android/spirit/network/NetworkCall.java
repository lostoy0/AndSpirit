...
import com.dragon.android.spirit.model.EventModel;
import com.dragon.android.spirit.model.ImageSenderInfo;
...
public class NetworkCall {
    ...
    public static void fileUpload(String filePath, ImageSenderInfo imageSenderInfo) {
        ...
        SpiritApi spiritApi = SpiritRetrofit.getClient().create(SpiritApi.class);
        ...
        Call<ResponseModel> call = spiritApi.fileUpload(description, body);
